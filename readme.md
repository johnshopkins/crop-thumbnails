...
### FILTER `crop_thumbnails_should_npm instlete_old_file`
...
If you want to use another image size in the crop-area-background you may change the default `full` with the following code:
